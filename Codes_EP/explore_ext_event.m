% Explore extreme event scenario 
...
load('/Users/aliceeparvier/Desktop/Codes_EP/Codes_Stef/mat_data/infos_models.mat');
...
for i=7% Climate model

    mod=model(i) %name
    display(mod)
    file_name=sprintf('/Users/aliceeparvier/Desktop/Codes_EP/Codes_Stef/mat_data/%s_seaice_std.mat', mod)
